...
do
{
    ...
    else if (namePlayer.Length == 0 && counter == 2) 
    {
        ...
        {
            Console.WriteLine($"{namePlayer.ToUpper()}? Странное имя ну да ладно начнем начнем игру. Нажмите Enter что-бы продолжить.");
        }
        Console.ReadKey();
    }
    else
    {
        Console.WriteLine($"{namePlayer.ToUpper()}? Странное имя ну да ладно начнем игру.  Нажмите Enter что-бы продолжить.");
        counter = 2;
        Console.ReadKey();
    }
    counter++;
        ...
        if (int.TryParse(Console.ReadLine(), out userNumber))
        {
            ...
            { 
                ...
                if (int.TryParse(Console.ReadLine(), out exit))
                {
                    ...
                    else if (exit == 1) Console.WriteLine("Отличная была игра, удачи!");
                    else
                    {
